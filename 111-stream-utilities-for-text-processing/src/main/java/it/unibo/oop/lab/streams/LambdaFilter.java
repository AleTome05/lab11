...
public final class LambdaFilter extends JFrame {
    ...
    private enum Command {
        ...
        CONVERT("To lowercase", String::toLowerCase),
        ...
        SORTED("List all the words in alphabetical order", s -> Arrays.stream(s.split("\\s+"))
            .sorted(String.CASE_INSENSITIVE_ORDER)
            .collect(Collectors.joining(" "))
        ),
        WORDCOUNTER("Write the count for each word", s -> Arrays.stream(s.split("\\s+"))
